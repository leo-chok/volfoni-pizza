...
sr.reveal('.home__pizza', {delay: 1000, distance: '100px', origin: 'bottom', rotate:{z: -135}})
sr.reveal('.home__ingredient', {delay: 2000, interval: 300, distance: '100px', origin: 'top', rotate:{z: (Math.random() * 450)}})
sr.reveal('.about__data, .recipe__list, contact__data', {origin: 'right'})
sr.reveal('.about__img, .recipe__img, .contact__image', {origin: 'left'})
sr.reveal('.products__card', {origin: 'bottom', interval: 150})
